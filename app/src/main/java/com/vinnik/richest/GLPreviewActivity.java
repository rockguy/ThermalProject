...
import com.vinnik.richest.models.PhotoModel;
import com.vinnik.richest.util.Analizer;
import com.vinnik.richest.util.MyLocationListener;
...
public class GLPreviewActivity extends Activity implements Device.Delegate, FrameProcessor.Delegate, Device.StreamDelegate{
    ...
    public void onFrameReceived(Frame frame) {
        Log.v(StartActivity.TAG, "Frame received!");
...
//                                i.putExtra("maxTemp", maxTemp);
                            ...
                            i.putExtra("theWeather",theWeather);
                            i.putExtra("airHumidity",airHumidity);
                            i.putExtra("windSpeed",windSpeed);
                            i.putExtra("outdoorTemp",outdoorTemp);
    ...
    private void doExperiment(){
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                String path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).toString() + '/' + StartActivity.TAG;
                ...
                Log.i(StartActivity.TAG, "Начало эксперимента");
                ...
                Log.i(StartActivity.TAG, "Фото ладони");
                ...
                Log.i(StartActivity.TAG, "Первое фото");
                ...
                Log.i(StartActivity.TAG, "Второе фото");
                ...
                Log.i(StartActivity.TAG, "Третье фото");
...
// Add a person
                        ...
                        photo.setHand_temp(handTemp);
                        photo.setResult("Lol result");

                        Log.i("Test", String.valueOf(photo.getHand_temp()));
...
//        maxTemp = inputIntent.getIntExtra("maxTemp", 0);
        ...
        theWeather = inputIntent.getStringExtra("theWeather");
        airHumidity = inputIntent.getIntExtra("airHumidity",0);
        windSpeed = inputIntent.getIntExtra("windSpeed",0);
        outdoorTemp = inputIntent.getIntExtra("outdoorTemp",0);
